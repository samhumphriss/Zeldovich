...
pos  = ic.main(args.redshift, pk, args.boxsize, args.ngrid, trand=args.truerand, seed=genseed)
densr = cdw.get_dens(pos[0],pos[1],pos[2], args.ngrid, args.boxsize)
densz = cdw.get_dens(pos[0],pos[1],pos[3], args.ngrid, args.boxsize)
